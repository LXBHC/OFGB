...
namespace OFGB
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private static bool CreateKey(string loc, string key)
        {
            ...
            if (keyRef is null)
            {
                MessageBox.Show("Failed to create a registry subkey during initialization 初始化期间创建注册表子键失败!", "OFGB: Fatal Error 致命错误", MessageBoxButton.OK, MessageBoxImage.Error);
